      ...
      <div class="widget atbd_widget widget-card">
        ...
        <div class="widget-body atbd_author_info_widget">
          ...
          <div class="row">
            ...
            <div class="col-lg-4">
              <a href="" class="btn btn-outline-info ">Telegram </a>
            </div>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="atbd_generic_header">
                <h4>Progreso y detalle de la meta</h4>
            ...
            <div class="col-lg-12 -items section-bg-w m-top-5">
                          ...
                          <div class="atbd_content_upper ">
                            <div class=" m-top-30 ">
                              <div class="feature-list-wrapper ">
                                <h5 class="m-bottom-20  m-left-25">Crear 2 nuevas normas o mecanismo de rendición de cuentas en las ciudades</h5>
                                ...
                                <div class="row m-left-10">
                                  <div class="col-lg-7 ">
                                    <h6 class="m-top-5"> 10% completado </h6>
                                    <div class="row m-bottom-10">

                                      <div class="col-lg-9">
                                        <div class="progress m-top-15" style="min-height: 10px !important;">
                                          <div class="progress-bar bg-success" role="progressbar" style="width: 10%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">
      ...
      <section class="all-listing-wrapper  section-bg ">
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="atbd_content_upper">
              <div class="feature-list-wrapper p-top-20 ">
                <div class="row m-left-10">
                  <div class="atbd_content_module atbd_review_form">
                    <div class="atbdb_content_module_contents atbd_give_review_area card-1 ">
                      ...
                      <form action="/" id="atbdp_review_form" method="post">
                        ...
                        <div class="row">
                          <div class="col-lg-6">
                            <h6 class="m-top-20"> Ver más detalles <ion-icon name="chevron-down-outline"></ion-icon>
                            </h6>
                          </div>
                          <div class="col-lg-6 ">
                            <div class="check-btn m-top-10 atbd_content_right ">
                              <div class="btn-checkbox active-color-success">
                                <label>
                                  <input type="checkbox" value="1"> <span class="color-success font-weight-bold ">
                                    <h6 class=" badge-pill m-right-10 badge-success"> 50 </h6>Cierto<i class="la la-check  m-left-10 font-weight-bold"></i>
                                  </span>
                                </label>
                              </div>
                              <div class="btn-checkbox active-color-danger">
                                <label>
                                  <input type="checkbox" value="1"> <span class="color-danger font-weight-bold ">
                                    <h6 class=" badge-pill m-right-10 badge-danger"> 20 </h6>Falso<i class="la la-check  m-left-10 font-weight-bold"></i>
                                  </span>
                                </label>
                              </div>
                            </div>
                ...
                <div class="row m-left-10">
                  <div class="atbd_content_module atbd_review_form">
                    <div class="atbdb_content_module_contents atbd_give_review_area card-1 ">
                      ...
                      <span class="badge badge-success">Inicio</span>
                      <span class="badge alert-link "> Compartir <ion-icon name="share-social-outline"></ion-icon>
                      </span>
